...
Expr         ::= (Val_Dcl | Val_Def) In_Sep Expr ['end']
...
Let_Binding  ::= Pattern ':=' Expr {',' Expr}
               | id [Type_Param_Clause] Param_Clauses [':' Type]
                 ':=' Expr
               | id [Type_Param_Clause] Params2 ':=' Expr
\end{lstlisting}
...
Param_Clause1 ::= '(' Param ')'
Params        ::= Param {',' Param}
Params2       ::= ['implicit'] Param {',' ['implicit'] Param}

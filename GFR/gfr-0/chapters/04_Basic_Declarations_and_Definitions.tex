...
\example The following method definition computes the sum of the squares of a variable number of integer arguments.\footnote{There is a space preceding the ``\code{*}'', because otherwise, \LaTeX would think there is a comment beginning, which it is not.}
\begin{lstlisting}

...
The vendor specified in module's \code{src/module.coral} is inherited by every source file in the same module and it's submodules (unless explicitly overwritten). 

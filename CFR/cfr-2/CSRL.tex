...
The \code{Lang} module is designed to be as much not intrusive as possible, e.g. the \code{Lang.Object} does not define any instance methods.\footnote{This is very much unlike e.g. Java, whose ~\lstinline!java.lang.Object!~ is pre-flooded with methods.} To allow users to use some typical methods querying \code{Object} instances, Coral offers attribute syntax along with those methods predefined in the \code{Lang.Predef} object (\sref{sec:lang-predef}). 

...
To retrieve the actual type of a value, the method \lstinline@.class@ can be used. This method is defined on every object and its return type is covariant -- it is always a \lstinline@Class@ (or a subtype, if any exists). 
...
\example Sample value type references. 

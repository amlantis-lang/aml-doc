...
is          lazy        let         loop        match
memoize     message     method      module      native
next        nil         no          object      of
opaque      operator    out         override    prepend
private     property    protected   protocol    public
raise       range       record      redo        refine
refinement  rescue      retry       return      requires
sealed      self        set         singleton-type
skip        step        super       then        this

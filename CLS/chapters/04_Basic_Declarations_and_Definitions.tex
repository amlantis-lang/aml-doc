...
\item The type of a mutable (instance) variable is always in invariant position (negative). 
\item The right-hand side of a type alias is always in invariant position (negative). 

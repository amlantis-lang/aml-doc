...
\item the signature of $m_1$ has the same name, the same type parameters (if any), the same parameters with equivalent types, and a result type that conforms to result type of $m_2$. 
\end{itemize}

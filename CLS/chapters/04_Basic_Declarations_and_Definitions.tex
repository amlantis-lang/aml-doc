...
Dcl         ::= [R_Modifier] 'val' Val_Dcl
              | [R_Modifier] 'var' Var_Dcl
              | 'def' Def_Dcl
              | 'message' Fun_Dcl 'end' ['message']
              | 'function' Fun_Dcl 'end' ['function']
              | 'type' Type_Dcl
Pat_Var_Def ::= [R_Modifier] 'val' Pat_Def
              | [R_Modifier] 'var' Var_Def
              | [R_Modifier] 'let' ['!'] id [Param_Clauses] 
                ':=' Expr
Def         ::= Pat_Var_Def
              | 'def' Fun_Def
...
\syntax\begin{lstlisting}
Dcl         ::= [R_Modifier] 'var' Var_Dcl
Pat_Var_Def ::= [R_Modifier] 'var' Var_Def
...
Coral provides automatic wrapping and unwrapping of variables that are declared or defined non-\code{strong}. Strong references are (usually) not wrapped in anything. 
...
This reference does not have a direct representation in Coral, but it can be emulated with the \code{Strong_Reference[$T$]} type. 
...
This reference type is represented in Coral by the type \code{Weak_Reference[$T$]}. 
...
This reference type is represented in Coral by the type \code{Unowned_Reference[$T$]}. 
...
This reference is represented in Coral by the type \code{Soft_Reference[$T$]}. 

...
All or parts of an expected type $\exptype$ may be undefined. The rules for conformace (\sref{sec:conformance}) are extended to this case by adding the rule that for any type $T$, the following two statements are always true:
\begin{itemize}

...
Cond_Modifier    ::= ('if' | 'unless') Infix_Expr
\end{lstlisting}
...
Loop_Ctrl_Expr ::= Break_Expr
                 | Skip_Expr
                 | Next_Expr
Break_Expr     ::= 'break' [label_id] [Cond_Modifier]
Skip_Expr      ::= 'skip' [integer_literal] [Cond_Modifier]
Next_Expr      ::= 'next' [label_id] [Cond_Modifier]
\end{lstlisting}
...
\subsection{Pure \& Classic Loops}

\syntax\begin{lstlisting}
Loop_Expr  ::= [Label_Dcl] 'loop' [Loop_Conds] 
               (nl Loop_Block_Expr 'end' ['loop'] | 
               '{' Loop_Block_Expr '}')
Loop_Conds ::= '(' [Exprs] semi [Exprs] semi [Exprs] ')'
\end{lstlisting}
...
Enumerator       ::= Generator
                   | Enumerator_Guard
                   | Pattern1 ':=' Expr
Generator        ::= Pattern1 '<-' Expr [Enumerator_Guard]
Enumerator_Guard ::= Cond_Modifier
\end{lstlisting}
...
\syntax\begin{lstlisting}
Return_Expr ::= 'return' [Expr] [Cond_Modifier]
\end{lstlisting}
...
Goto_Expr  ::= 'goto' label_name [Cond_Modifier]

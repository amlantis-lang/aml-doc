...
% TBD: add "attributes": 
% predefined attributes like: obj'Class -> Class.of(obj)
% custom attributes like: obj'Custom -> Custom(obj)
% +args: obj'Custom(arg) -> Custom(obj)(arg)
% keyword: attribute ? - maybe
% annotation: @[attribute] ? - probably not, possible collisions
\section{Designators}
...
% TBD: rename to receiver universal shortcut, change size to operator $

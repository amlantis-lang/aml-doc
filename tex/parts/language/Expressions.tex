...
What we call ``statement'', in context of GeAmlar is in fact yet another kind of an expression, and those expressions themselves always have a type and a value. 
...
Tuple expressions have the runtime type of ~\lstinline!Aml/Language.Tuple_$n$[$T_1 \commadots T_n$]!, where each $T_i$ is the known type of each $e_i$, including the annotations that name sub-expressions. 

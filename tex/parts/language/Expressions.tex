...
Value_Expr  ::= App_Expr
App_Expr    ::= Value_Expr '(' [Arguments] ')' [Block_Arg]
              | Value_Expr '.' '(' [Arguments] ')' [Block_Arg]
              | Value_Expr Arguments [Block_Expr2 | Method_Expr]
              | Value_Expr Block_Arg
...
Pos_Arg     ::= ['*' | '?'] Value_Expr 
              ...
              | TT_Expr
              | Slice_Expr
Named_Args  ::= {Named_Arg}+ {'**' Value_Expr}
              | {'**' Value_Expr}+
Named_Arg   ::= ['~' | '?'] id ':' (Value_Expr | TT_Expr | Slice_Expr)
              | ['~' | '?'] id ':' '$'
              | ('~' | '?') id

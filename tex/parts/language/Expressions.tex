...
% TODO: redo the following with <- being the language feature and := being a regular operator (with standard library implementations for certain types, like 'a ref and 'a var.

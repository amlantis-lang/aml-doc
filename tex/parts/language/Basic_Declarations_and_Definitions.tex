...
Declaring a property $x$ of type $T$ is equivalent to declarations of a {\em getter function} $x$ and a {\em setter function} \lstinline!set-$x$!, declared as follows:

\begin{lstlisting}
message $x$ (): $T$ end
message set-$x$ (y: $T$): () end
\end{lstlisting}

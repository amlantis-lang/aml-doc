...
\grammar\begin{lstlisting}
Val_Dcl 
    ::= [Storage_Modifier] 'val' id {',' id} ':' Type
Val_Def 
    ::= [Storage_Modifier] ('val' | 'let') ['rec'] Let_Binding {'and' Let_Binding}
Let_Binding
    ::= Let_Value_Binding
      | Let_Fun_Binding
Let_Value_Binding
    ::= Pattern [Type_Param_Clause] [':' Type] '=' Expr {',' Expr}
Let_Fun_Binding
    ::= fun_id [Type_Param_Clause] [Given_Clauses] Param_Clauses [':' Type] '=' Expr
\end{lstlisting}
...
\grammar\begin{lstlisting}
Var_Dcl 
    ::= [Storage_Modifier] 'var' id {',' id} ':' Type
Var_Def 
    ::= [Storage_Modifier] 'var' Var_Binding
Var_Binding 
    ::= Let_Binding
      | id {',' id} ':' Type '=' ('_' | Constant)
\end{lstlisting}
...
A variable definition ~\lstinline!var $x$: $T$ = _!~ introduces a mutable variable with type $T$ and a default initial value. The default value is defined by the ~\lstinline!Default[$T$]!~ type class, defined for some standard types as follows:
...
Prop_Get_Impl 
    ::= '{' Block '}'
      ...
      | '_'
Prop_Set_Impl 
    ::= '{' '|' Param '|' [':' Type semi] Block '}'
      | 'do' '|' Param '|' [':' Type semi] Block 'end' 
...
Locally_Abstract_Type_Param_Clause 
    ::= '(' 'type' Locally_Abstract_Type_Param {semi Locally_Abstract_Type_Param} ')'
Locally_Abstract_Type_Param
    ::= id [Type_Param_Clause] [Type_Equation | Type_Abstract]
\end{lstlisting}
...
Variant_Type_Param 
    ::= ...
      | {Annotation} 'type' ['+' | '-'] Locally_Abstract_Type_Param
\end{lstlisting}
...
\grammar\begin{lstlisting}
Message_Dcl 
    ::= 'message' Fun_Sig 'end' ['message']
Op_Dcl 
    ::= 'operator' Op_Sig 'end' ['operator']
Att_Dcl 
    ::= 'attribute' Att_Sig 'end' ['attribute']
Method_Def 
    ::= 'method' Fun_Sig '=' [Fun_Dec] Expr
Op_Def  
    ::= 'operator' Op_Sig '=' [Fun_Dec] Expr
Att_Def
    ::= 'attribute' Att_Sig '=' [Fun_Dec] Expr
Fun_Dec
    ::= [nl] 'declare' Fun_Dec_Exprs In_Sep
Fun_Dec_Exprs 
    ::= Fun_Dec_Expr {semi Fun_Dec_Expr}
Fun_Sig 
    ::= Function_Path [Type_Param_Clause] [Given_Clauses] Param_Clauses [':' Type]
Op_Sig 
    ::= Op_Path [Type_Param_Clause] [Given_Clauses]
        Param_Clause Param_Clauses [':' Type]
Att_Sig 
    ::= Function_Path [Type_Param_Clause] [Given_Clauses]
        Param_Clause Param_Clauses [':' Type]
        (* it is an error if the first param clause only accepts Unit *)
Function_Path 
    ::= fun_id
      | Long_Id '.' fun_id
Op_Path 
...
Value_Param_Clause
    ::= Atomic_Pattern
      ...
      | '~(' Reflected_Param_Extra id [':' Type] ')'
      | '~' Reflected_Param_Extra id ':' Atomic_Pattern
      | '~' Reflected_Param_Extra id ':' '(' Pattern [':' Type] ')'
      | '~?' Reflected_Param_Extra id
      | '~?(' Reflected_Param_Extra id [':' Param_Type] ['=' Expr] ')'
      | '~?' Reflected_Param_Extra id ':' Atomic_Pattern
      | '~?' Reflected_Param_Extra id ':' '(' Pattern [':' Type] ['=' Expr] ')'
      | '(' [Params] ')'
...
Block_Capture_Param
    ::= '&' ['val' | 'var'] id
      ...
      | '~&' id ':' '(' Type ['as' Var_Pattern] ['=' Expr] ')'
Variadic_Param 
    ::= Positional_Variadic_Param [Capture_Variadic_Param]
      | Capture_Variadic_Param
Positional_Variadic_Param
    ::= '*(' [Mutability_Modifier] ['val' | 'var'] var_id [':' Type] ')'
      | '*'  [Mutability_Modifier] ['val' | 'var'] var_id [':' Atomic_Pattern]
Capture_Variadic_Param
    ::= '**(' [Mutability_Modifier] ['val' | 'var'] var_id [':' Type] ')'
      | '**'  [Mutability_Modifier] ['val' | 'var'] var_id [':' Atomic_Pattern]
Params 
    ::= Positional_Params {',' Labelled_Params}
      | Labelled_Params
Positional_Params
    ::= Positional_Param {',' Positional_Param} [',' Rest_Params {',' Positional_Param}]
...
Labelled_Params 
    ::= Labelled_Param {',' Labelled_Param} [',' Capture_Extract]
      | Capture_Extract
Labelled_Param 
    ::= Labelled_Pattern
      | '~' Param_Extra id 
      ...
      | '~?(' Param_Extra id [':' Param_Type] ['=' Expr] ')'
      | '~?' Param_Extra id ':' Pattern
      | '~?' Param_Extra id ':' '(' Pattern [':' Param_Type] ['=' Expr] ')'
Param_Extra 
    ::= [Eagerness] [Mutability_Modifier] [Param_Rw]

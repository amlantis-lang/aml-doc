...
Dcl ::= ...
      | Val_Dcl
Val_Dcl 
    ::= [S_Modifier] 'val' id {',' id} ':' Type
Val_Def 
    ::= [S_Modifier] ('val' | 'let') ['rec'] Let_Binding {'and' Let_Binding}
Let_Binding
...
Dcl ::= ...
      | Var_Dcl
Var_Dcl 
    ::= [S_Modifier] 'var' id {',' id} ':' Type
Var_Def 
    ::= [S_Modifier] 'var' Var_Binding
Var_Binding 
    ::= Let_Binding
      | id {',' id} ':' Type ':=' '_'
\end{lstlisting}
...
Locally_Abstract_Type_Param_Clause 
    ::= '(' 'type' id [Type_Equation | Type_Abstract] ')'
\end{lstlisting}
...
Locally_Abstract_Type_Param
    ::= id [Type_Param_Clause] Type_Param_Constraints
\end{lstlisting}

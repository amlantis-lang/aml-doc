...
\begin{enumerate}
  ...
  \item The getter and setter, including both implicit and explicit versions, automatically wrap (assignment) or unwrap (evaluation) the corresponding reference type. The default values defined with \code{val} or \code{var} do the same. 
...
\begin{lstlisting}
Prop_Get_Impl 
    ::= ? Block_Expr without parameters ?
      | '_'
Prop_Set_Impl 
    ::= ? Block_Expr with exactly one parameter ?
      | '_'
\end{lstlisting}
...
\grammar\begin{lstlisting}
Message_Dcl 
    ::= 'message' fun_id [':' Function_Type] 'end' ['message']
Operator_Dcl 
    ::= 'operator' op_id [':' Function_Type] 'end' ['operator']
Attribute_Dcl 
    ::= 'attribute' id [':' Function_Type] 'end' ['attribute']
Method_Def 
    ::= 'method' fun_id Method_Type_Clauses
        Single_Method_Identity Param_Clauses [':' Type] 
        '=' Single_Method_Body
      | 'multi' 'method' fun_id Method_Type_Clauses
        Multi_Method_Identity Param_Clauses [':' Type] 
        '=' Single_Method_Body
      | 'multi' 'method' fun_id Method_Type_Clauses 
        Single_Method_Identity Param_Clauses [':' Type] 
        '=' Multi_Method_Bodies
...
Operator_Def
    ::= 'operator' op_id Method_Type_Clauses 
        Single_Method_Identity Param_Clause Param_Clauses [':' Type] 
        '=' Single_Method_Body
      | 'multi' 'operator' op_id Method_Type_Clauses 
        Multi_Method_Identity Param_Clause Param_Clauses [':' Type] 
        '=' Single_Method_Body
      | 'multi' 'operator' op_id Method_Type_Clauses
        Single_Method_Identity Param_Clause Param_Clauses [':' Type] 
        '=' Multi_Method_Bodies

...
Object_Definition 
    ::= Object_Modifiers 'object' Type_Name [':' Trait_Type]
        ['=' | '+='] Standalone_Object_Expr 'end' ['object']
Trait_Definition 
    ::= Trait_Modifiers 'trait' Type_Name [':' Trait_Type]
        ('=' | '+=') Trait_Expr
Extension_Definition
    ::= Trait_Modifiers 'extension' Type_Name 'for' Parameterized_Type [':' Class_Body_Type]
        ('=' | '+=') Extension_Expr
Refinement_Definition
...
Extension_Specification
    ::= Trait_Modifiers 'extension' Type_Name 
        'for' Parameterized_Type ':' Class_Body_Type
Refinement_Specification
    ::= 'refinement' Parameterized_Type ':' Trait_Type
    
Class_Modifiers
    ::= [Access_Modifier] ['implicit'] ['open'] ['sealed'] ['case' | 'abstract']
      | [Access_Modifier] ['implicit'] ['open'] 'final' ['case']
Trait_Modifiers
...
\section{Class Definitions \& Specifications}
...
Class_Expr
    ::= (* only in non-recursive occurrences: *)
      ...
      | 'fun' {Params_Clause}+ [Guard] '->' [Function_Declarations] Class_Expr
...
Class_Use_Expr_As
    ::= 'use' Expr ('as' | 'as!' | 'as?')
        [['var' | 'val'] id ':'] Type In_Sep Class_Expr
Class_Use_Aspect
...
Class_Binding_Expr
    ::= ['implicit'] Val_Def In_Sep Class_Expr
      | ['implicit'] Var_Def In_Sep Class_Expr
...
Ivar_Def
    ::= Ivar_Modifiers ('val' | 'var') id [':' Type_Expr] '=' Expr
Ivar_Spec
    ::= Ivar_Modifiers ('val' | 'var') id [':' Type_Expr] {',' id [':' Type_Expr]}
      | Ivar_Modifiers ('val' | 'var') '(' id {',' id} ')' [':' Type_Expr]
Ivar_Modifiers
...
\subsection{Trait Specifications}
...
\grammar\begin{lstlisting}
Class_Definition    ::= ['monitored'] 'class' Class_Def
...
A class definition defines the type signature, behaviour and initial state of a class of objects (the instances of the defined class) and of the class object, which is the class instance itself, with behaviour defined in its metaclass (\sref{sec:metaclasses}). 
...
\grammar\begin{lstlisting}
Constructor_Def
    ::= ['convenience'] 'constructor' [Param_Clauses] '=' [Fun_Dec] Expr
Destructor_Def 
    ::= 'destructor' '=' [Fun_Dec] Expr
\end{lstlisting}
...
\begin{enumerate}
  ...
  \item After the root destructor is applied, strong reference count to the destructed object is checked. If it is non-zero, a runtime error is raised (\code{Object_Resurrection_Error}).

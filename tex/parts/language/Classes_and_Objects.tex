...
Trait_Definition     ::= ['monitored'] 'trait' Trait_Def
...
\grammar\begin{lstlisting}
Class_Parents  ::= Base_Call {['prepend'] 'with' Annot_Type} 
Trait_Parents  ::= Annot_Type {['prepend'] 'with' Annot_Type}
Template_Body  ::= [Self_Type] Template_Stat {semi Template_Stat}
Self_Type      ::= 'use' 'self' 'as' 'val' id [':' Type] In_Sep
                 | 'use' 'self' 'as' Type In_Sep
\end{lstlisting}
...
\grammar\begin{lstlisting}
Upgrade_Constructor_Def 
    ::= 'upgrade' 'constructor' '(' id [':' 'Self'] ')' '=' Expr
\end{lstlisting}

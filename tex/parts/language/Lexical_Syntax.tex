...
required      reverse       scope         sealed        self
...
\syntax\begin{lstlisting}
real_number_literal
     ::= integer_literal | fp_literal
imaginary_literal 
     ::= real_number_literal 'i'
complex_literal
     ::= [real_number_literal ('+' | '-') ] imaginary_literal

...
Compound_Type 
    ::= Annot_Type [Nullable_Mod] ['with' Annot_Type {'and' Annot_Type} ['and' Refine_Stats]] 
      | Annot_Type [Nullable_Mod] ['with' Refine_Stats]
      | Refine_Stats
\end{lstlisting}
...
A refinement \lstinline@{$R$}@ contains declarations and definitions (\sref{sec:refinements}). 
...
\grammar\begin{lstlisting}
Postfix_Type 
    ::= Compound_Type 'with' Constraint_Block
Simple_Type
    ::= ...
      | '@(' Expr ')'
Constraint_Block 

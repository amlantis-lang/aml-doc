...
Type_Constr_Dcl     ::= {Annotation} id ['of' Types]
\end{lstlisting}
...
Gadt_Field          ::= {Annotation}+ id [Type_Param_Clause] ':' [Type '->'] Type
\end{lstlisting}
...
Record_Component    ::= {Annotation} {Record_Modifier} ['val' | 'var'] id ':' (Type | id)
...
Record_Case         ::= 'when' ('.' Long_Id | Stable_Id) ['(' [Extractions] ')']
...
Record_Modifier     ::= Access_Modifier 
                      | Mutability
\end{lstlisting}

...
Introducing the \code{Default[$T$]} and \code{Not_Nil} traits. Describing consistency relation for the gradual typing system. Refining typed expressions to make use of \code{Type_Convertible[$S$]}. Describing contracts. 

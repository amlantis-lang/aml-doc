...
\begin{tabular}{ r l }
  ...
  \lstinline!'! & starts a type variable; see \nameref{subsec:aml-base-lang-reader-tyvars}. \\
...
\subsection{Reading Type Variables}
\label{subsec:aml-base-lang-reader-tyvars}
